...
**详细文档:**
- [Agent 模式使用指南](./docs/guides/agent-mode-guide.md) - Agent 模式完整文档
...
- 📖 [完整文档索引](docs/README.md) - 所有项目文档导航
- 🚀 [部署指南](docs/guides/deployment-guide.md) - PM2/Docker 部署完整指南
- 🔌 [API 使用指南](docs/guides/api-guide.md) - API 使用和最佳实践
- 🤖 [Agent 模式指南](docs/guides/agent-mode-guide.md) - Agent 模式使用说明
- 🏗️ [系统架构](docs/architecture/system-architecture.md) - 技术架构文档
- 📊 [项目报告](docs/reports/) - 里程碑完成报告和测试报告

## 注意事项

1. **OpenAI 兼容模式** - 不支持多轮对话上下文（无状态请求）
2. **Agent 模式** - 支持完整的会话管理和工具调用
3. **性能考虑** - 每次请求启动新的 Claude CLI 进程
